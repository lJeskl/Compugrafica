...
MyGame.prototype._createALight = function (
  type,
  pos,
  dir,
  color,
...
MyGame.prototype._initializeLights = function () {
  ...
  var l = this._createALight(
    ...
    8,
    20, // near and far distances
    0.1,
    0.2, // inner and outer cones
    5, // intensity
    1.0 // drop off
  );
  ...
  l = this._createALight(
    ...
    [0.7, 0.7, 0.0, 1], // color
    500,
    500, // near anf far distances: essentially switch this off
    0.1,
    0.2, // inner and outer cones
    2, // intensity
    1.0 // drop off
  ...
  l = this._createALight(
    ...
    [0.5, 0.5, 0.5, 1], // color
    20,
    40, // near and far distances
    1.9,
    2.0, // inner outter angles (in radius)
    5, // intensity
    1.2 // drop off
  );
  this.mGlobalLightSet.addToSet(l);
